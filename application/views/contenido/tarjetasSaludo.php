          ...
          <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="grid_6">
                    <div class="post2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                      <div class="head">
                        <div class="row">
                          <div class="grid_4">
                            <h5>
                              <a href="#">
                              <?php echo $tarjetas_item->tasa_titulo ?>
                              </a>
                            </h5>
                          </div>
                      ...
                      <img src="<?php echo base_url(); ?>images/<?php echo $tarjetas_item->tasa_imagen ?>" alt="" width="150" height="200" onmouseover="resize(this,400,636);" onmouseout="resize(this,150,200);"/>
                      <p><?php echo $tarjetas_item->tasa_texto ?></p>
                      <br />
                      <a href="#"><p class="strong">Solicite su <?php echo $tarjetas_item->tasa_titulo ?></p></a>                      
                    </div>
                  </div>
           ...
           <div class="grid_3 preffix_1">
              ...
              <div class="blockquote1-wrapper2">
                <a class="twitter-timeline" width=100% height="440" data-chrome=" noborders transparent noscrollbar" href="https://twitter.com/santaclarachile" data-widget-id="591051549088055296">
