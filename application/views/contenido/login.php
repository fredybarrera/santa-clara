        ...
        <div class="container">
          <div class="row">
            <div class="grid_8">
              ...
              <?php 
                  echo form_open('', 'method="POST" id="login-form"');
                  echo "<fieldset>";
                  echo form_input('nombre', set_value('nombre'), 'id="nombre" placeholder="Nombre de usuario"').'<br />';
                  echo form_error('nombre', '<div class="error-mensaje">', '</div>');
                  echo form_password('clave', '', 'id="clave" placeholder="Contraseña"').'<br />';
                  echo form_error('clave', '<div class="error-mensaje">', '</div>');
                  echo form_submit('submit', 'Ingresar', 'class="btn-default-login"') .'<br />';
                  echo 'Olvido su clave? recupérela '. anchor('welcome/RecuperarClave', 'Aquí');
                  echo "</fieldset>";
                  echo form_close(); 
              ?>
            </div>
            <div class="grid_3 preffix_1">
              <div class="maxheight with-border1">
                ...
                <div class="blockquote1-wrapper1">
                  <a class="twitter-timeline"  href="https://twitter.com/santaclarachile" data-widget-id="591051549088055296">
