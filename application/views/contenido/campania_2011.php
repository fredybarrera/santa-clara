                  ...
                  <div class="grid_6">
                    <div class="post2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                      <div class="grid_4">
                        <h5>
                          <a href="#">
                            Campaña Navideña de Starbucks
                          </a>
                        </h5>
                      </div>
                      <br />
                      <br />
                      <img src="<?php echo base_url(); ?>images/imagen_campana_starbucks_navidad_pagina.png" alt=""/>
                      <br />
                      <br />
                      <div class="info">
                  ...
                  <div class="grid_6">
                    <div class="post2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                      <div class="grid_4">
                        <h5>
                          <a href="#">
                            Colecta Agosto 2011 - Video Promocional
                          </a>
                        </h5>
                      </div>
                      <br />
                      <br />
                      <iframe width="425" height="349" src="https://www.youtube.com/embed/o3-lbLJnFTU" frameborder="0" allowfullscreen></iframe>
                      <br />
                      <br />
                      <div class="info">
                        <time datetime="2014-01-01">December 14, 2013</time>
                  ...
                  <div class="grid_6">
                    <div class="post2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                      <div class="grid_4">
                        <h5>
                          <a href="#">
                            Apoyo de Jose Miguel Viñuela
                          </a>
                        </h5>
                      </div>
                      <br />
                      <br />
                      <img src="<?php echo base_url(); ?>images/feira_pulgas.png" alt=""/>
                      <br />
                      <br />
                      <div class="info">
                        <time datetime="2014-01-01">December 14, 2013</time>
