              ...
              <div class="menu-wrapper">
                <nav>
                  <ul class="sf-menu">
                    ...
                    <li class="current"><?php echo anchor('welcome/entorno', 'Qué hacemos'); ?>
                    <ul>
          ...
          <div class="row">
            ...
            <div class="grid_8">
              <div class="maxheight">
                ...
                <div class="box5  ">
                      <img src="<?php echo base_url(); ?>images/imagen_como_ayudamos_01.png" alt="" width="320" height="240" class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"/>
                      <img src="<?php echo base_url(); ?>images/imagen_como_ayudamos_02.png" alt="" width="320" height="240" class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"/>   
                        <div class="grid_13 wow fadeInUp">        
                        <p align="justify"  class="wow fadeInUp" >La fundación Santa Clara, a través de la Casa de Acogida, entrega atención integral a los niños (as) bajo la condicionante del VIH/SIDA, preocupándose de su bienestar y de la adherencia de la triterapia, que se refiere a la rigurosidad en el sumunistro de los medicamentos.</p>
                        <p align="justify"class="wow fadeInUp">Nos preocupamos de insertar a estos niños en la sociedad, a fin de que ésta los acepte y respete.</p>                  
                        </div>
                      <img src="<?php echo base_url(); ?>images/imagen_como_ayudamos_03.png" alt="" width="320" height="240" class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"/>
                      <img src="<?php echo base_url(); ?>images/imagen_como_ayudamos_04.png" alt="" width="320" height="240" class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"/>
                      <br><br>
              ...
              <div class="heading1 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.1s">
                ...
                <div class="box5-wrapper1 maxheight1">                        
                  <div class="blockquote1-wrapper2">
                      <a class="twitter-timeline" width=100% height="250" data-chrome=" noborders transparent noscrollbar" href="https://twitter.com/santaclarachile" data-widget-id="591051549088055296">
