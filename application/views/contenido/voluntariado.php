          ...
          <div class="row">
            <div class="grid_8">
              <div class="maxheight">
                ...
                <div class="box6">
                  <img src="<?php echo base_url(); ?>images/imagen_voluntariado.png" alt="" class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"/>               
                <div class="preffix_1">
                  <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"> 
                    Si usted desea ser voluntario de la Casa de Acogida, debe llamara al teléfono (2) 27320399 para
                    coordinar una entrevista con la asistente social y, posteriormente, una entrevista con la psicóloga.<br />
                    Este programa se implementó con la intención de apoyar en las funciones específicas que requiere la institución.
                  </p>
                  <br />
                  <p class="wow fadeInUp strong" data-wow-duration="1s" data-wow-delay="0.3s">
                    Para solicitar entrevistas para padrinos, voluntarios y visitas para los niños se deben comunicar a la Casa de Acogida a los teléfonos 227 320 399 - 227 770 571. 
                  </p>
              ...
              <div class="heading1 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.1s">
                ...
                <div class="box5-wrapper1 maxheight1">                        
                  <div class="blockquote1-wrapper2">
                      <a class="twitter-timeline" width=100% height="340" data-chrome=" noborders transparent noscrollbar" href="https://twitter.com/santaclarachile" data-widget-id="591051549088055296">
