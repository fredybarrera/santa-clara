          ...
          <div class="row">
            <div class="grid_8">
              ...
              <div class="post2-wrapper1">
                <div class="row">
                  ...
                  <div class="grid_7">
                    <div class="post2 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                      ...
                      <br />
                      <img src="<?php echo base_url(); ?>images/noticias/<?php echo $noticias_item->noti_imagen ?>" alt=""/>
                      <div class="info">
                        <time datetime="2014-01-01"><?php echo $noticias_item->noti_fecha ?></time>
                        <span class="by">posted by <a href="#">Admin</a></span>
                      </div>
                      <p><?php echo word_limiter($noticias_item->noti_contenido, 60, '...'); ?></p>
                      <?php 
                        $link = "welcome/articulo/".$noticias_item->noti_slug;
                        echo anchor($link, 'Seguir leyendo', 'class="btn-default wow"'); 
                      ?>
                    </div>
                     <hr class="hr1"/>
                  </div>
                ...
                <div class="page-navigation wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                  <?php echo $paginacion ?>
                </div>
