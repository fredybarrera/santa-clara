                ...
                <div class="grid_12">
                  <div class="row">
                      ...
                      <h2>Editar vídeo</h2>
                        ...
                        <div class= "box_inner">
                        <div class= "box4">
                        <?php echo form_open('admin/update_video_inicio', 'method="post"'); ?>
                          <div class="box4-wrapper1 maxheight1">                    
                            <h3>
                              <p>Título del video</p>
                              <?php echo form_input('vide_titulo', $video_item['vide_titulo'], 'id="vide_titulo" title="Titulo del video" class="" placeholder="Max 500 caracteres" required'); ?>
                            </h3>
                            <br />
                            <h3>
                              <p>Link del video</p>                              
                            ...
                            <h3>
                              ...
                              <?php echo $this->ckeditor->editor("vide_contenido", $video_item['vide_contenido']); ?>
                              </div>
                            </h3>
                            <br />
                            <h3>
                              <p>Estado del video</p>
                              <input type="radio" name="estado" value="1" <?php echo set_value('estado', $video_item['vide_estado']) == ESTADO_ACTIVO ? "checked" : ""; ?> />Activo <br />
                              <input type="radio" name="estado" value="-1" <?php echo set_value('estado', $video_item['vide_estado']) == ESTADO_INACTIVO ? "checked" : ""; ?> />Inactivo
                            </h3>
                            <br />
                            <h3>
                              <p>¿Definir como video principal?</p>
                              <input type="radio" name="vide_principal" value="1" <?php echo set_value('vide_principal', $video_item['vide_principal']) == ESTADO_ACTIVO ? "checked" : ""; ?> />Activo <br />
                              <input type="radio" name="vide_principal" value="-1" <?php echo set_value('vide_principal', $video_item['vide_principal']) == ESTADO_INACTIVO ? "checked" : ""; ?> />Inactivo
                            </h3>
                            <br />
                            <?php echo form_hidden('vide_id', $video_item['vide_id'], ''); ?>
                            <?php echo form_hidden('vide_slug', $video_item['vide_slug'], ''); ?>
