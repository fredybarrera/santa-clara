            ...
            <div class="row">
                <div class="grid_12">
                  <div class="row">
                      ...
                      <div class="grid_6">
                      <h2>Cargar nueva tarjeta de saludo</h2>
                        <br />
                        <br />
                        <div class= "box_inner">
                        <div class= "box4">
                        <?php echo  form_open_multipart('admin/upload_tarjeta_saludo'); ?>
                          <div class="box4-wrapper1 maxheight1">
                            <h3>
                              <p>Título de la tarjeta de saludo</p>
                              <?php echo form_input('tasa_titulo', '', 'id="tasa_titulo" title="Titulo de la tarjeta" class="" placeholder="Max 500 caracteres" required'); ?>
                            </h3>
                            <br />
                            <h3>
                              <p><?php echo form_label('Seleccionar foto de tarjeta', 'userfile') ?></p>
                            </h3>
                            ...
                            <h3>
                              ...
                              <?php echo $this->ckeditor->editor("tasa_texto", ''); ?>
                            </h3>
                            <br />
                            <h3>
                              <p>Estado de la tarjeta de saludo</p>
                              <input type="radio" name="tasa_estado" value="1" required/>Activa <br />
                              <input type="radio" name="tasa_estado" value="-1" required/>Inactiva
                            </h3>
                            <br />
