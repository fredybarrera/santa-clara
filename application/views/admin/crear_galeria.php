                ...
                <div class="grid_12">
                  <div class="row">
                      ...
                      <h2>Crear galería</h2>
                        ...
                        <div class= "box_inner">
                        <div class= "box4">
                        <?php echo form_open('admin/set_galeria_noticia', 'method="post"'); ?>
                          <div class="box4-wrapper1 maxheight1">                    
                            <h3>
                              <p>Nombre de la galería</p>
                              <?php echo form_input('gaim_titulo', '', 'id="gaim_titulo" title="Nombre de la galería" class="" placeholder="Max 500 caracteres" required'); ?>
                            </h3>
                            <br />
                            <h3>
                              <p>Descripción de la galeria</p>
                              <div style="min-height: 400px;">
                              <?php echo $this->ckeditor->editor("gaim_descripcion", ''); ?>
                            </div>
                            </h3>
                            <br />
                            <h3>
                              <p>Estado de la galería</p>
                              <input type="radio" name="gaim_estado" value="1" required/>Activa <br />
                              <input type="radio" name="gaim_estado" value="-1" required/>Inactiva
                            </h3>
                            <br />
                            <?php echo form_submit('submit', 'Guardar', 'class="btn-default-submit"'); ?><br /><br />
                            <?php echo anchor('admin/noticias', 'Volver', 'class="btn-default-volver"');  ?>
                            <?php echo form_hidden('noti_id', $noti_id, ''); ?>
                        </div>   
                        <?php echo form_close(); ?>
                        </div>                      
                        </div>
