            ...
            <div class="row">
                <div class="grid_12">
                  <div class="row">
                      ...
                      <div class="grid_6">
                      <h2>Registrar nuevo patrocinador</h2>
                        <br />
                        <br />
                        <div class= "box_inner">
                        <div class= "box4">
                        <?php echo  form_open_multipart('admin/upload_patrocinador'); ?>
                          <div class="box4-wrapper1 maxheight1">
                            <h3>
                              <p>Url del patrocinador</p>
                              <?php echo form_input('patr_url', '', 'id="patr_url" title="Url del patrocinador" class="" placeholder="Max 500 caracteres" required'); ?>
                            </h3>
                            <br />
                            <h3>
                              <p><?php echo form_label('Seleccionar foto patrocinador', 'userfile') ?></p>
                            </h3>
                            ...
                            <h3>
                              ...
                              <input type="radio" name="patr_estado" value="1" required/>Activo <br />
                              <input type="radio" name="patr_estado" value="-1" required/>Inactivo
                            </h3>
                            <br />
