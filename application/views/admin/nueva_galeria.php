            ...
            <div class="row">
                <div class="grid_12">
                  <div class="row">
                      ...
                      <div class="grid_6">
                      <h2>Cargar nueva imágen de galería</h2>
                        <br />
                        <br />
                        <div class= "box_inner">
                        <div class= "box4">
                        <?php echo  form_open_multipart('admin/upload_galeria'); ?>
                          <div class="box4-wrapper1 maxheight1">
                            <p><?php echo form_label('Subir foto de galería', 'userfile') ?></p>
                            ...
                            <h3>
                              ...
                              <?php echo $this->ckeditor->editor("gapi_texto", ''); ?>
                            </div>
                            </h3>
                            <br />
                            <h3>
                              <p>Estado de la imágen</p>
                              <input type="radio" name="gapi_estado" value="1" />Activa <br />
                              <input type="radio" name="gapi_estado" value="-1" />Inactiva
                            </h3>
                            <br />
