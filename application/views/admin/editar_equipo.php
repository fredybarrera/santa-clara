                ...
                <div class="grid_12">
                  <div class="row">
                      ...
                      <h2>Editar funcionario</h2>
                        ...
                        <div class= "box_inner">
                        <div class= "box4">
                        <?php echo form_open('admin/update_equipo', 'method="post"'); ?>
                          <div class="box4-wrapper1 maxheight1">                    
                            <h3>
                              <p>Nombre funcionario</p>
                              <?php echo form_input('equi_nombre', $equipo_item['equi_nombre'], 'id="equi_nombre" title="Nombre del funcionario" class="" placeholder="Max 500 caracteres" required'); ?>
                            </h3>
                            <br />
                            <h3>
                              <p>Cargo funcionario</p>
                              <?php echo form_input('equi_cargo', $equipo_item['equi_cargo'], 'id="equi_cargo" title="Cargo funcionario" class="" placeholder="Max 500 caracteres" required'); ?>
                            </h3>
                            <br />
                            <?php echo form_hidden('equi_id', $equipo_item['equi_id'], ''); ?>
